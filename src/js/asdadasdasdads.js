App = {
  ...
  web3 = new Web3(App.web3Provider);
    ...
    initContract: function() {
      $.getJSON('ProjectOffice.json', async function(data) {
    ...
    bindEvents: async function() {
      $(document).on('click', '.btn-primary', App.handleAdopt,async function(){
        ...
        $.ajax({
          ...
          success: function (data) {
              alert('YOUR INTERVATION HAVE BEEN CREATED');
          }
      });
      })
    },
    ...
    markAdopted: function() {
      var adoptionInstance;
        ...
        App.contracts.ProjectOffice.deployed().then(function(instance) {
          ...
          App.contracts.ProjectOffice.set(1,1,1,1,1, {from: account})
        }).catch(function(err) {
